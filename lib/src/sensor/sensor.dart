...
import 'package:hue_api/src/sensor/sensor_model.dart';
...
abstract class Sensor
  ...
  Map? toBridgeObject({String? action}) {
    if ('create' == action) {
      return serializers.serializeWith(Sensor.serializer, this) as Map<dynamic, dynamic>?;
      ...
      return serializers.serializeWith(serializer, state) as Map<dynamic, dynamic>?;
    }
    return null;
  }
}
